...
#define zlib_version zlibVersion1()
/* for compatibility with versions < 1.0.2 */

                        /* basic functions */

ZEXTERN const char * ZEXPORT zlibVersion1 OF((void));
...
ZEXTERN int ZEXPORT compress OF((Bytef *dest,   uLongf *destLen,
                                 const Bytef *source, uLong sourceLen,int nCompression));
/*
...
ZEXTERN const char   * ZEXPORT zError1           OF((int err));
